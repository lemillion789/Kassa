...
def setup_telemetry() -> str | None:
    ...
    if bucket and capture_content != "false":
        ...
        os.environ.setdefault(
            ...
            f"service.namespace=ambient-finance-agent,service.version={commit_sha}",
        )
    ...
    try:
        ...
        logging.warning(
            f"Could not load GCP default credentials; skipping Cloud Trace/Logging telemetry setup: {e}"
        )
